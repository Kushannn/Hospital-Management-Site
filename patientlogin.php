...
if (isset($error['login'])) {
    ...
    $show = "<h5 class='relative block w-full p-4 text-base leading-5 text-white bg-red-500 rounded-lg opacity-100 mt-8'>$l</h5>";
} else {
    $show = "";
}
?>
        ...
        <button class="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]">
          ...
          Login with Google
                ...
                <div class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                    <p>Register Here</p>
                    <a href='patientregister.php' class="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">Register</a>
                </div>
            </div>

            <!-- image -->
            <div class="md:block hidden w-1/2">
                <img class="rounded-2xl" src="images/doctorlogin.jpg">
            </div>
        </div>
    </section>
