...
if (isset($_POST['apply'])) {
    ...
    if (empty($firstname)) {
        ...
        $error['apply'] = "Enter your speciality";
    ...
    if (count($error) == 0) {
        $query = "INSERT INTO doctors(firstname,surname,username,email,gender, phone, speciality, password, salary, data_reg, status, profile) VALUES ('$firstname','$lastname','$username','$email','$gender','$phone','$speciality','$password','0',NOW(),'pending','doctor.jpg')";
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6 min-h-screen" method="post">
                        ...
                        <div>
                            ...
                            <input type="submit" name="apply" value="Apply Now" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-green-500 text-white hover:green-600">
                        </div>
