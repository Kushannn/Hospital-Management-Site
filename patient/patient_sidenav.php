...
<body class="box-border m-0 font-poppins">
    ...
    <div class="flex flex-col pl-0 mb-0 border rounded border-gray-300 bg-blue-400 md:w-48 md:h-screen w-lvw">
        ...
        <a href="./appointment.php" class="relative block py-1 px-6 -mb-px border border-r-0 border-l-0 border-gray-300 no-underline w-full bg-blue-400 text-white transform transition duration-500 hover:scale-110 h-16 text-lg">
            Book Appointments
        </a>
        ...
        <a href="./invoice.php" class="relative block py-3 px-6 -mb-px border border-r-0 border-l-0 border-gray-300 no-underline w-full bg-blue-400 text-white transform transition duration-500 hover:scale-110 h-16 text-lg">
            Invoice
        </a>
    </div>
    <!--sidebar ends-->
