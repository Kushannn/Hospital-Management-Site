                        ...
                        <div class="flex flex-wrap">
                            <div class="md:w-1/2 pr-4 pl-4">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="file" name="img" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded my-2">
                                    <input type="submit" name="upload" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-teal-500 text-white hover:bg-teal-600">
                                </form>
