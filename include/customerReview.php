                    ...
                    <div class="keen-slider__slide">
                        <blockquote class="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                            <div>
                                ...
                                <div class="mt-4">
                                    <p class="text-2xl font-bold text-rose-600 sm:text-3xl">Time Saving</p>

                                    <p class="mt-4 leading-relaxed text-gray-700">
                                        "As someone with a busy schedule, finding time to visit a traditional hospital can be a hassle. That's why I turned to this online hospital, and I couldn't be happier with the experience. The website is user-friendly, scheduling appointments is easy, and the doctors are professional and thorough. It's revolutionized the way I approach healthcare.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="keen-slider__slide">
                        <blockquote class="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                            <div>
                                ...
                                <div class="mt-4">
                                    <p class="text-2xl font-bold text-rose-600 sm:text-3xl">A true lifesaver</p>

                                    <p class="mt-4 leading-relaxed text-gray-700">
                                        "I recently had a telemedicine appointment through this online hospital, and I was blown away by the level of care I received. The doctor took the time to listen to my concerns and provided personalized treatment recommendations. Plus, being able to access medical care from anywhere is a game-changer. This service is a lifesaver!
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="keen-slider__slide">
                        <blockquote class="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                            <div>
                                ...
                                <div class="mt-4">
                                    <p class="text-2xl font-bold text-rose-600 sm:text-3xl">Extremely flexible</p>

                                    <p class="mt-4 leading-relaxed text-gray-700">
                                        I'm someone who values efficiency and convenience, which is why I love using this online hospital. Booking appointments is quick and easy, and I never have to wait long to see a doctor. Plus, the doctors are always thorough and attentive, making sure all my questions are answered. It's healthcare made simple, and I couldn't be happier with the service
                                    </p>
                                </div>
                            </div>
